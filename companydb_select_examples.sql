...
where Plocation = "Houston" or Dnumber = "4" ;
...
select CONCAT(fname, ' ', minit, ' ', lname),ssn
 from employee; 
...
from employee e inner join works_on w on e.ssn=w.essn where w.hours >= 20;
